...
export const addShoppingItemSuccess = createAction('[SHOPPING] Add Shopping Item Success', props<{ payload: ShoppingItem }>());
...
export const deleteShoppingItemSuccess = createAction('[SHOPPING] Delete Shopping Item Success', props<{ id: string }>());
